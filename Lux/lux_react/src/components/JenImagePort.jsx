...
import JenImagePortCanvas from './JenImagePortCanvas.jsx';

function JenImagePort({ dimensions, moduleReady }) {
    ...
    return (
        ...
        >
            {/* Use your existing JenImagePortCanvas component */}
            <Box
                sx={{
                    width: '100%',
                    height: '100%',

...
struct eff_noise;
template<class T>
struct eff_checkerboard;
template<class T>
struct eff_grayscale;
template<class T>
struct eff_invert;
template<class T>
struct eff_rotate_components;
template<class T>
struct eff_rgb_to_hsv;
template<class T>
struct eff_hsv_to_rgb;
template<class T>
struct eff_rotate_hue;

template<class T>
struct eff_crop_circle;
template<class T>
struct eff_mirror;
template<class T>
struct eff_turn;
...
struct eff_feedback;
template<class T>
struct eff_vector_warp;

// Vector field effects
template<class T>
struct eff_complement;
template<class T>
struct eff_radial;
template<class T>
struct eff_cartesian;
template<class T>
struct eff_rotate_vectors;
template<class T>
struct eff_scale_vectors;
template<class T>
struct eff_normalize;
template<class T>
struct eff_inverse;
template<class T>
struct eff_inverse_square;
template<class T>
struct eff_concentric;
template<class T>
struct eff_rotational;
template<class T>
struct eff_spiral;
template<class T>
struct eff_fermat_spiral;
template<class T>
struct eff_vortex;
template<class T>
struct eff_turbulent;
template<class T>
struct eff_kaleidoscope;
template<class T>
struct eff_radial_tile;
template<class T>
struct eff_theta_rotate;
template<class T>
struct eff_theta_swirl;
template<class T>
struct eff_theta_rings;
template<class T>
struct eff_theta_waves;
template<class T>
struct eff_theta_saw;
template<class T>
struct eff_theta_compression_waves;
template<class T>
struct eff_radial_multiply;
template<class T>
struct eff_position_fill;

// warp field effects
template<class T>
struct eff_fill_warp;

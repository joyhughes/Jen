...
September 2021 <br>
<img src = "https://miro.medium.com/max/1400/1*d6pv0GgJkzDXMIc54xgG2Q.jpeg" height = 200 > <br>
...
With a Latin name meaning "Living Light", Lux Vitae is now the main renderer for Jen, encompassing the features of all previous and subsequent projects. Each element is "splatted" into the scene and can be masked, rotated, scaled, colored, or modified using effects such as Life, Warp, Melt, Hyper, or Kaleido. A script file generated by hand or by Niffer specifies the composition of the scene, and if desired a simple animation loop. Clusters of elements can spawn subclusters, a mathematical construct known as an L-system.
